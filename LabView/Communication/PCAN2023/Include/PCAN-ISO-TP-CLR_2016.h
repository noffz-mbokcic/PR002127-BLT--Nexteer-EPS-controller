...
//  Last changed date:	$Date: 2021-01-27 14:43:15 +0100 (mer., 27 janv. 2021) $
//
//  Language: C++.Net CLR
//  ------------------------------------------------------------------
//
...
#pragma region Enumerations
			...
			public enum cantp_device : UInt32
			{
				...
				/// </summary>
				PCANTP_DEVICE_PEAKCAN = (UInt32)TPCANDevice::PCAN_PEAKCAN,
				/// <summary>
...
#pragma region ISO - TP extra information flags
				...
				/// Receiver side timeout while transmitting
				/// </summary>
				PCANTP_STATUS_NETWORK_TIMEOUT_Ar = (PCANTP_STATUS_FLAG_NETWORK_RESULT | (PCANTP_NETSTATUS_TIMEOUT_Ar << (cantp_status_offset::PCANTP_STATUS_OFFSET_NET + 1))),
				/// <summary>
				/// Sender side timeout while transmitting
				/// </summary>
				PCANTP_STATUS_NETWORK_TIMEOUT_As = (PCANTP_STATUS_FLAG_NETWORK_RESULT | (PCANTP_NETSTATUS_TIMEOUT_As << (cantp_status_offset::PCANTP_STATUS_OFFSET_NET + 1))),
				/// <summary>
				/// input was modified
				/// </summary>
...
#pragma endregion
			...
			public enum cantp_parameter : UInt32
			{
				...
				/// </summary>
				PCANTP_PARAMETER_DEVICE_ID = (UInt32)TPCANParameter::PCAN_DEVICE_ID,
				/// <summary>
				/// Deprecated use PCANTP_PARAMETER_DEVICE_ID instead
				/// </summary>
				PCANTP_PARAMETER_DEVICE_NUMBER = (UInt32)TPCANParameter::PCAN_DEVICE_ID,
				/// <summary>
			...
			public enum cantp_can_msgtype : UInt32
			{
				...
				/// </summary>
				PCANTP_CAN_MSGTYPE_FLAG_INFO = ((UInt32)TPCANMessageType::PCAN_MESSAGE_ERRFRAME | (UInt32)TPCANMessageType::PCAN_MESSAGE_STATUS)
			};
...
#pragma region Structures
			...
			public value struct cantp_msginfo
			{
				/// <summary>
				...
				/// (read-only) reserved
				/// </summary>
				cantp_msginfo_flag flags;
				/// <summary>
				/// (read-only) reserved
				/// </summary>
				cantp_msginfo_extra extra;
			};
			...
			/// </summary>
			[StructLayout(LayoutKind::Sequential, Pack = 8)]
			public value struct cantp_msgrule
			{
				/// <summary>
				/// Unique ID (read-only)
				/// </summary>
...
#pragma region operators
			...
			inline cantp_statustype	operator|	(cantp_statustype a, cantp_statustype b) { return static_cast<cantp_statustype>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_statustype& operator|=	(cantp_statustype& a, cantp_statustype b) { return (a = (a | b)); };
			inline cantp_statustype	operator&	(cantp_statustype a, cantp_statustype b) { return static_cast<cantp_statustype>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_statustype& operator&=	(cantp_statustype& a, cantp_statustype b) { return (a = (a & b)); };
			inline cantp_statustype operator~	(cantp_statustype a) { return static_cast<cantp_statustype>(~static_cast<UInt32>(a)); };
			// extra operator for cantp_status
			inline cantp_status	operator|	(cantp_status a, cantp_status b) { return static_cast<cantp_status>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_status& operator|=	(cantp_status& a, cantp_status  b) { return (a = (a | b)); };
			inline cantp_status	operator&	(cantp_status a, cantp_status b) { return static_cast<cantp_status>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_status& operator&=	(cantp_status& a, cantp_status  b) { return (a = (a & b)); };
			inline cantp_status operator~	(cantp_status a) { return static_cast<cantp_status>(~static_cast<UInt32>(a)); };
			// extra operator for cantp_msgflag
			inline cantp_msgflag operator|	 (cantp_msgflag a, cantp_msgflag b) { return static_cast<cantp_msgflag>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_msgflag& operator|= (cantp_msgflag& a, cantp_msgflag  b) { return (a = (a | b)); };
			inline cantp_msgflag operator&	 (cantp_msgflag a, cantp_msgflag b) { return static_cast<cantp_msgflag>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_msgflag& operator&= (cantp_msgflag& a, cantp_msgflag  b) { return (a = (a & b)); };
			inline cantp_msgflag operator~	 (cantp_msgflag a) { return static_cast<cantp_msgflag>(~static_cast<UInt32>(a)); };
			// extra operator for cantp_msgflag
			inline cantp_can_msgtype operator|	 (cantp_can_msgtype a, cantp_can_msgtype b) { return static_cast<cantp_can_msgtype>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_can_msgtype& operator|= (cantp_can_msgtype& a, cantp_can_msgtype  b) { return (a = (a | b)); };
			inline cantp_can_msgtype operator&	 (cantp_can_msgtype a, cantp_can_msgtype b) { return static_cast<cantp_can_msgtype>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_can_msgtype& operator&= (cantp_can_msgtype& a, cantp_can_msgtype  b) { return (a = (a & b)); };
			inline cantp_can_msgtype operator~	 (cantp_can_msgtype a) { return static_cast<cantp_can_msgtype>(~static_cast<UInt32>(a)); };
			// extra operator for cantp_isotp_msgtype
			inline cantp_isotp_msgtype operator|	(cantp_isotp_msgtype a, cantp_isotp_msgtype b) { return static_cast<cantp_isotp_msgtype>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_isotp_msgtype& operator|=	(cantp_isotp_msgtype& a, cantp_isotp_msgtype  b) { return (a = (a | b)); };
			inline cantp_isotp_msgtype operator&	(cantp_isotp_msgtype a, cantp_isotp_msgtype b) { return static_cast<cantp_isotp_msgtype>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_isotp_msgtype& operator&=	(cantp_isotp_msgtype& a, cantp_isotp_msgtype  b) { return (a = (a & b)); };
			inline cantp_isotp_msgtype operator~	 (cantp_isotp_msgtype a) { return static_cast<cantp_isotp_msgtype>(~static_cast<UInt32>(a)); };
			// extra operator for cantp_infostatus
			inline cantp_infostatus operator|	(cantp_infostatus a, cantp_infostatus b) { return static_cast<cantp_infostatus>(static_cast<UInt32>(a) | static_cast<UInt32>(b)); };
			inline cantp_infostatus& operator|=	(cantp_infostatus& a, cantp_infostatus  b) { return (a = (a | b)); };
			inline cantp_infostatus operator&	(cantp_infostatus a, cantp_infostatus b) { return static_cast<cantp_infostatus>(static_cast<UInt32>(a)& static_cast<UInt32>(b)); };
			inline cantp_infostatus& operator&=	(cantp_infostatus& a, cantp_infostatus  b) { return (a = (a & b)); };
			inline cantp_infostatus operator~	 (cantp_infostatus a) { return static_cast<cantp_infostatus>(~static_cast<UInt32>(a)); };

#pragma endregion

#pragma region PCANTP Api
#if defined(PCANTP_API_COMPATIBILITY_ISO_2004)
			public ref class CanTpApi_2016
#else
			public ref class CanTpApi
#endif
			{
			public:
...
#pragma region bitrate
				...
				//
				static const String^ PCANTP_BITRATE_CLOCK = PCANBasic::PCAN_BR_CLOCK;
				static const String^ PCANTP_BITRATE_CLOCK_MHZ = PCANBasic::PCAN_BR_CLOCK_MHZ;
				static const String^ PCANTP_BITRATE_NOM_BRP = PCANBasic::PCAN_BR_NOM_BRP;
				static const String^ PCANTP_BITRATE_NOM_TSEG1 = PCANBasic::PCAN_BR_NOM_TSEG1;
				static const String^ PCANTP_BITRATE_NOM_TSEG2 = PCANBasic::PCAN_BR_NOM_TSEG2;
				static const String^ PCANTP_BITRATE_NOM_SJW = PCANBasic::PCAN_BR_NOM_SJW;
				static const String^ PCANTP_BITRATE_NOM_SAMPLE = PCANBasic::PCAN_BR_NOM_SAMPLE;
				static const String^ PCANTP_BITRATE_DATA_BRP = PCANBasic::PCAN_BR_DATA_BRP;
				static const String^ PCANTP_BITRATE_DATA_TSEG1 = PCANBasic::PCAN_BR_DATA_TSEG1;
				static const String^ PCANTP_BITRATE_DATA_TSEG2 = PCANBasic::PCAN_BR_DATA_TSEG2;
				static const String^ PCANTP_BITRATE_DATA_SJW = PCANBasic::PCAN_BR_DATA_SJW;
				static const String^ PCANTP_BITRATE_DATA_SAMPLE = PCANBasic::PCAN_BR_DATA_SAMPLE;
#pragma endregion

#pragma region PCANTP parameter values

				static const Byte PCANTP_VALUE_PARAMETER_OFF = PCANBasic::PCAN_PARAMETER_OFF;
				static const Byte PCANTP_VALUE_PARAMETER_ON = PCANBasic::PCAN_PARAMETER_ON;
				/// <summary>
				/// Enable debug messages (only notices, informations, warnings, errors)
				/// </summary>
				static const Byte PCANTP_DEBUG_NOTICE = 0xF4;
				/// <summary>
				/// Enable debug messages (only informations, warnings, errors)
				/// </summary>
				static const Byte PCANTP_DEBUG_INFO = 0xF3;
				/// <summary>
				/// Enable debug messages (only warnings, errors)
				/// </summary>
				static const Byte PCANTP_DEBUG_WARNING = 0xF2;
				/// <summary>
				/// Enable debug messages (only errors)
				/// </summary>
				static const Byte PCANTP_DEBUG_ERROR = 0xF1;
				...
				/// </summary>
				static const Byte PCANTP_FRAME_FILTERING_CAN = 0x01;
				/// <summary>
				/// enable reception of unformatted (NON-ISO-TP) CAN frames
				...
				/// </summary>
				static const Byte PCANTP_STMIN_ISO_15765_2 = 10;
				/// <summary>
				/// Default value for BlockSize
				/// </summary>
				static const Byte PCANTP_BS_ISO_15765_2 = 10;
				/// <summary>
				/// Default value for Timeout Ar in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_AR_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for Timeout As in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_AS_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for Timeout Br in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_BR_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for Timeout Bs in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_BS_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for Timeout Cr in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_CR_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for Timeout Cs in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_CS_ISO_15765_2 = (1000 * 1000);
				/// <summary>
				/// Default value for timeout tolerance [0..100] (timeout = t * (1 + tolerance/100))
				/// </summary>
				static const Byte PCANTP_TIMEOUT_TOLERANCE = 0;
				...
				/// </summary>
				static const Byte PCANTP_STMIN_ISO_15765_4 = 0;
				/// <summary>
				/// OBDII value for BlockSize
				/// </summary>
				static const Byte PCANTP_BS_ISO_15765_4 = 0;
				/// <summary>
				/// OBDII value for Timeout Ar in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_AR_ISO_15765_4 = (1000 * 33);
				/// <summary>
				/// OBDII value for Timeout As in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_AS_ISO_15765_4 = (1000 * 33);
				/// <summary>
				/// OBDII value for Timeout Br in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_BR_ISO_15765_4 = (1000 * 75);
				/// <summary>
				/// OBDII value for Timeout Bs in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_BS_ISO_15765_4 = (1000 * 75);
				/// <summary>
				/// OBDII value for Timeout Cr in µs
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_CR_ISO_15765_4 = (1000 * 150);
				/// <summary>
				/// OBDII value for Timeout Cs in µs (Cs+As < 50ms)
				/// </summary>
				static const UInt32 PCANTP_TIMEOUT_CS_ISO_15765_4 = (1000 * 17);
				...
				/// </summary>
				static const Byte PCANTP_FLAG_MASK_PRIORITY = 0x07;
				/// <summary>
				/// Padding is enabled
				/// </summary>
				static const Byte PCANTP_FLAG_PADDING_ON = 0x08;
				/// <summary>
				/// Message's indication is enabled
				/// </summary>
				static const Byte PCANTP_FLAG_INDICATION_ON = 0x10;
				/// <summary>
				/// Echo of fragmented frames is enabled
				/// </summary>
				static const Byte PCANTP_FLAG_ECHO_FRAMES_ON = 0x20;
#pragma endregion
...
#pragma region constants
				...
				/// </summary>
				static const UInt32 PCANTP_MAPPING_FLOW_CTRL_NONE = 0xFFFFFFFF;
#pragma endregion

#pragma region PCAN ISO - TP API Implementation
			...
			public:
				...
				static cantp_status AddMsgRule_2016(
					[MarshalAs(UnmanagedType::U4)]
					cantp_handle channel,
				...
				static cantp_status RemoveMsgRule_2016(
					[MarshalAs(UnmanagedType::U4)]
					cantp_handle channel,
					UIntPtr uid);
			...
			private:
				...
				static Byte byteMsgEqual_2016(
					[In] cantp_msg %msg_buffer1,
					[In] cantp_msg %msg_buffer2,
			...
			public:
				...
				/// <returns>A boolean stating if the cantp_msgs are equal.</return
				static bool MsgEqual_2016(
					cantp_msg %msg_buffer1,
					cantp_msg %msg_buffer2,
					bool ignoreSelfReceiveFlag)
				{
					return (0 != byteMsgEqual_2016(msg_buffer1, msg_buffer2, ignoreSelfReceiveFlag));
				};
			...
			private:
				...
				static Byte byteStatusIsOk_2016(
					[MarshalAs(UnmanagedType::U4)]
				cantp_status status,
					[MarshalAs(UnmanagedType::U4)]
			...
			public:
				...
				static bool StatusIsOk_2016(
					...
					bool strict)
				{
					return (0 != byteStatusIsOk_2016(status, status_expected, strict));
				};
